...
public enum EnumOptionsMinimap {
    ...
    SHOW_WAYPOINT_NAMES("options.voxelmap.waypoints.show_waypoint_names", false, false, true),
    SHOW_WAYPOINT_DISTANCES("options.voxelmap.waypoints.show_waypoint_distances", false, false, true),
