...
public enum EnumOptionsMinimap {
    ...
    SHOW_BIOME_LABEL("options.voxelmap.show_biome_label", false, true, false),
    ...
    RADAR_FONT_SCALE("options.voxelmap.radar.font_size", true, false, false),
    ...
    WAYPOINT_SIZE("options.voxelmap.waypoints.icon_size", true, false, false),
    ...
    SHOW_WAYPOINT_NAME("options.voxelmap.waypoints.show_name_label", false, false, true),
    SHOW_WAYPOINT_DISTANCE("options.voxelmap.waypoints.show_distance_label", false, false, true),
