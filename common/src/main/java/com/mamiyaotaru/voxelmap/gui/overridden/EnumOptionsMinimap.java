...
public enum EnumOptionsMinimap {
    ...
    MOVE_SCOREBOARD_BELOW_MAP("options.voxelmap.scoreboardbelowmap", false, true, false),
    MOVE_MAP_BELOW_STATUS_EFFECT("options.voxelmap.movemapdownwhilestatuseffect", false, true, false),
