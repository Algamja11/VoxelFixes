        ...
        for (Contact contact : this.contacts) {
            ...
            if (inRange) {
                try {
                    ...
                    this.textureAtlas.getAtlasSprite("contact").blit(guiGraphics, GLUtils.GUI_TEXTURED_LEQUAL_DEPTH, x - 4, y - 4, 8, 8, color);
                    if (this.options.showFacing) {
                        this.textureAtlas.getAtlasSprite("facing").blit(guiGraphics, GLUtils.GUI_TEXTURED_LEQUAL_DEPTH, x - 4, y - 4, 8, 8, color);
                    }
                } catch (Exception e) {
